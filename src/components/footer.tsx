    ...
    <footer className="footer">
      ...
      <div className="container footer-content">
        <div className="footer-grid">
          ...
          <div className="footer-section">
            <h4 className='mb-4 uppercase text-base font-bold'>Quick Links</h4>
          ...
          <div className="footer-section">
            <h4 className='mb-4 uppercase text-base font-bold'>Connect With Us</h4>
          ...
          <div className="footer-section">
            <h4 className='mb-4 uppercase text-base font-bold'>Join Our Community</h4>
